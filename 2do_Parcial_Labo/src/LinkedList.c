...
/// @fn int ll_map(LinkedList*, void(*)(void*))
/// @brief recibe una lista y un puntero a funcion con un criterio que hara que se modifiquen valores de un elemento, reccorre la lista y obtiene cada elemento de esta
/// y se los va pasando a la funcion
///
/// @param this LinkedList* Puntero a la lista
/// @param  pFunc (*pFunc) Puntero a la funcion criterio
/// @return retornta -1 si la lista y la funcion es = NULL
/// retorna 0 si se logro la operacion
